...
//TOGGLING NESTED ul
$(".switchDropdown .selected a").click(function() {
    $(".switchDropdown .options ul").toggle();
});

//SELECT OPTIONS AND HIDE OPTION AFTER SELECTION
$(".switchDropdown .options ul li a").click(function() {
    var text = $(this).html();
    $(".switchDropdown .selected a span").html(text);
    $(".switchDropdown .options ul").hide();
});
...
$(document).bind('click', function(e) {
    ...
    if (!$clicked.parents().hasClass("switchDropdown"))
        $(".switchDropdown .options ul").hide();
});